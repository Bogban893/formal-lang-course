...
**Обратите внимание, что подразумевается необходимость оптимизации ранее реализованных решений. Возможно, использование более высокопроизводительных библиотек и т.д.**
...
- [ ] Сформировать набор данных.
  - [ ] Выбрать некоторые графы из [набора](https://formallanguageconstrainedpathquerying.github.io/CFPQ_Data/graphs/index.html). **Выбирать графы с количеством вершин не менее 10 000 (десяти тысяч).** Не забудьте обосновать, почему выбрали именно эти графы.
